...
const communities=[{
  name:'All for good',id:1,slug:'all-for-good-erd4',membersCount:20,members:[{
  ...
  name:'Live life to fullness',id:2,slug:'live-life-to-fullness-fed3',membersCount:10,members:[{

  }],cover:'',description:'Experience a community that encourages you to savor every bite and live life to the fullest through mindful nutrition. In "Live Life to Fullness," we embrace a holistic approach to well-being, celebrating the pleasures of nourishing both body and soul. Discover a wealth of resources, connect with fellow members on a journey to vitality, and learn how to make every aspect of your life more fulfilling through balanced and joyful nutrition.'
},{
  name:'Meet your faves',id:3,slug:'meet-your-faves-acd2',membersCount:45,members:[{

  }],cover:'',description:'Discover a vibrant community where nutrition enthusiasts unite to share their favorite recipes, wellness tips, and success stories. Connect with like-minded individuals, learn from nutrition experts, and celebrate the joy of nourishing your body. In "Meet Your Faves," we believe that building a supportive network is key to embracing a healthier lifestyle together.'
}]
              ...
              >
                <Flex align={'start'} gap={4} mb={5}>
                  ...
                  <Box>
                    ...
                    <Text as={Flex} gap={1} alignItems={'center'} fontWeight={'medium'} className='text-secondaryGray'>
